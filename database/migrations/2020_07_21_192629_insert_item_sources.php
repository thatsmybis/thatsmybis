    ...
    public function up()
    {
        ...
        DB::insert('INSERT INTO `item_sources` (`name`, `slug`, `instance_id`, `npc_id`, `object_id`, `order`, `created_at`)
            VALUES
                ...
                ("Quraji Items",           "quraji-items",           5, null, null, 2, "2020-07-21 00:00:00"),
                ...
                ("Trash",                   "trash",                   6, null, null, 1, "2020-07-21 00:00:00"),
                ("Enchants",                "enchants",                6, null, null, 2, "2020-07-21 00:00:00"),
                ("Mounts",                  "mounts",                  6, 21321, null, 3, "2020-07-21 00:00:00"),
                ("The Prophet Skeram",      "the-prophet-skeram",      6, 15263, null, 4, "2020-07-21 00:00:00"),
                ("Bug Trio",                "bug-trio",                6, 15543, null, 5, "2020-07-21 00:00:00"),
                ("Battleguard Sartura",     "battleguard-sartura",     6, 15543, null, 6, "2020-07-21 00:00:00"),
                ("Fankriss the Unyielding", "fankriss-the-unyielding", 6, 15510, null, 7, "2020-07-21 00:00:00"),
                ("Viscidus",                "viscidus",                6, 15299, null, 8, "2020-07-21 00:00:00"),
                ("Princess Huhuran",        "princess-huhuran",        6, 15509, null, 9, "2020-07-21 00:00:00"),
                ("Twin Emperors",           "twin-emperors",           6, 15276, null, 10, "2020-07-21 00:00:00"),
                ("Ouro",                    "ouro",                    6, 15517, null, 11, "2020-07-21 00:00:00"),
                ("C\'Thun",                 "cthun",                   6, 15517, null, 12, "2020-07-21 00:00:00"),
