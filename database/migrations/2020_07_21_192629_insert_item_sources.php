    ...
    public function up()
    {
        ...
        DB::insert('INSERT INTO `item_sources` (`name`, `slug`, `instance_id`, `npc_id`, `object_id`, `order`, `created_at`)
            VALUES
                ...
                ("Golemagg the Incinerator", "golemagg-the-incinerator", 1, 11988, null, 10, "2020-07-21 00:00:00"),
                ("Sulfuron Harbinger",       "sulfuron-harbinger",       1, 12098, null, 11, "2020-07-21 00:00:00"),
                ("Majordomo Executus",       "majordomo-executus",       1, 12018, null, 12, "2020-07-21 00:00:00"),
                ...
                ("Buru the Gorger",        "buru-the-gorger",        5, 15370, null, 7, "2020-07-21 00:00:00"),
                ("Ayamiss the Hunter",     "ayamiss-the-hunter",     5, 15369, null, 8, "2020-07-21 00:00:00"),
                ("Ossirian the Unscarred", "ossirian-the-unscarred", 5, 15339, null, 9, "2020-07-21 00:00:00"),
