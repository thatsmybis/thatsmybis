                        ...
                        <div id="importArea" class="col-12" style="display:none;">
                            ...
                            <div id="input-string" class="form-group">
                                <textarea id="importTextarea"
                                    ...
                                    rows="20"
                                    placeholder="{{ __('(LootReserve addon now supported)') . ' ' . __('Accepts RCLootCouncil and Gargul CSV data, or any CSV. First line must contain headers for the data (case sensitive).') }}
eg.
