                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="lootNavDropdown">
                            ...
                            <div class="dropdown dropright">
                                ...
                                <div class="dropdown-menu" aria-labelledby="adminItemNotes">
                                    ...
                                    @elseif ($guild->expansion_id == 6)
                                        ...
                                        <a class="dropdown-item" href="{{ route('guild.item.list.edit', ['guildId' => $guild->id, 'guildSlug' => $guild->slug, 'instanceSlug' => 'throne-of-thunder-n']) }}">{{ __("Throne of Thunder Normal") }}</a>
                                        <a class="dropdown-item" href="{{ route('guild.item.list.edit', ['guildId' => $guild->id, 'guildSlug' => $guild->slug, 'instanceSlug' => 'throne-of-thunder-h']) }}">{{ __("Throne of Thunder Heroic") }}</a>
                            ...
                            <div class="dropdown dropright">
                                ...
                                <div class="dropdown-menu" aria-labelledby="adminPrioDropdown">
                                    ...
                                    @elseif ($guild->expansion_id == 6)
                                        ...
                                        <a class="dropdown-item" href="{{ route('guild.prios.chooseRaidGroup', ['guildId' => $guild->id, 'guildSlug' => $guild->slug, 'instanceSlug' => 'throne-of-thunder-n']) }}">{{ __("Throne of Thunder Normal") }}</a>
                                        <a class="dropdown-item" href="{{ route('guild.prios.chooseRaidGroup', ['guildId' => $guild->id, 'guildSlug' => $guild->slug, 'instanceSlug' => 'throne-of-thunder-h']) }}">{{ __("Throne of Thunder Heroic") }}</a>
                        ...
                        @elseif ($guild->expansion_id == 6)
                            ...
                            <a class="dropdown-item" href="{{ route('guild.item.list', ['guildId' => $guild->id, 'guildSlug' => $guild->slug, 'instanceSlug' => 'throne-of-thunder-n']) }}">{{ __("Throne of Thunder Normal") }}</a>
                            <a class="dropdown-item" href="{{ route('guild.item.list', ['guildId' => $guild->id, 'guildSlug' => $guild->slug, 'instanceSlug' => 'throne-of-thunder-h']) }}">{{ __("Throne of Thunder Heroic") }}</a>
